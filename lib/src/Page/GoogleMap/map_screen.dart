...
//                   ),
//           TextField(
//               controller: state.startSearchFieldController,
...
//                 suffixIcon: state.startSearchFieldController.text.isNotEmpty
//                   ?IconButton(onPressed: (){
//                     setState(() {
//                       state.predictions = [];
//                       state.startSearchFieldController.clear();
//                     });
...
//               onChanged:(value){
//                   if(value.isNotEmpty){
//                     state.autoCompleteSearch(value);
//                   }else{
//                     setState(() {
//                       state.predictions = [];
//                       startPosition = null;
